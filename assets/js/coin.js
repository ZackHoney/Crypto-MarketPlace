                    ...
                    <div class="container">
                        <div class="item">
                            ...
                            <div class="links">
                                ...
                                <p style="background-color: ${coin.tickers[0].trust_score}">Trust</p>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="links">
                                ...
                                <p style="background-color: ${coin.tickers[1].trust_score}">Trust</p>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="links">
                                ...
                                <p style="background-color: ${coin.tickers[2].trust_score}">Trust</p>
                            </div>
                        </div>
                    </div>
                </div>
